...
|---|---|---|---|
| GWAS Catalog | All associations v1.0 | `gwas-catalog-associations.tsv` | https://www.ebi.ac.uk/gwas/api/search/downloads/associations/v1.0?split=false |
| ClinVar | 2025-12-08 | `clinvar.vcf.gz` | https://ftp.ncbi.nlm.nih.gov/pub/clinvar/vcf_GRCh38/ |
| Open Targets Platform | 25.12 | `association_by_datasource_direct/`, `target/` | https://ftp.ebi.ac.uk/pub/databases/opentargets/platform/25.12/output/ |
| OMIM | 2022-06-09 | `genemap2.txt` | https://omim.org/downloads |
| Genebass | 500k | `results.mt` | `gs://ukbb-exome-public/500k/results/results.mt` (requires GCP account); preprocess with `scripts/fetch/genebass_preprocess.py` (requires Hail + Java 17) |
...
| TrialPanorama | 2025-08-22 | Full dataset | https://huggingface.co/datasets/TrialPanorama/TrialPanorama-database |

## Ontology and mappings

| Resource | Version | Files | Download |
|---|---|---|---|
| EFO | v3.84.0 | `efo.obo` | https://github.com/EBISPOT/efo/releases |
| OxO cross-references | — | OMIM-to-EFO, MeSH-to-EFO, MONDO/Orphanet/HP-to-EFO | Included in data release |
| UK Biobank phenotype manifest | — | `ukb_phenotype_manifest.tsv` | Included in data release |
